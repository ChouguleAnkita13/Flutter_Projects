...
import 'package:jewellery_app/profilepage.dart';
        ...
        children:[ Column(
                     ...
                     return Column(
                       children: [
                         GestureDetector(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(100),
                            child: Image.asset(categoriesList[index]['product'][0]['imgs'],fit :BoxFit.cover)),
                          )                 
                        ),
          ...
          Row(children: [
            Container(
              ...
              child: Image.asset("assets/home/img1.png",height: 170,width: 110,)
            ),
            Container(
              padding: const EdgeInsets.all(10),
              child: Image.asset("assets/home/img2.png",height: 170,width: 110,)
            ),
            Container(
              padding: const EdgeInsets.all(10),
              child: Image.asset("assets/home/img3.png",height: 170,width: 110,)
            ),
          ],
         ),
         Row(children: [
            Container(
              padding: const EdgeInsets.all(10),
              child: Image.asset("assets/home/img4.png",height: 170,width: 110,)
            ),
            Container(
              padding: const EdgeInsets.all(10),
              child: Image.asset("assets/home/img5.png",height: 170,width: 110,)
            ),
            Container(
              padding: const EdgeInsets.all(10),
              child: Image.asset("assets/home/img6.png",height: 170,width: 110,)
            ),
          ],
         ),
        ],
